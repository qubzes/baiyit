...
export function ConciergeChat({ messages, onSendMessage, isLoading }: ConciergeChatProps) {
  ...
  return (
    <div className="glass-panel h-full flex flex-col">
      <div className="p-4 border-b border-gray-200">
        <h2 className="text-xl font-bold text-primary-navy">Baiyit Concierge</h2>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {groupedMessages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center p-6">
            ...
            <p className="text-gray-500 mb-6 max-w-xs">Ask about products, upload images, or get recommendations</p>
            ...
            {groupedMessages.map((group, groupIndex) => (
              <div key={groupIndex} className="mb-6">
                <div className="flex justify-center mb-4">
                  <span className="text-xs bg-gray-100 text-gray-500 px-3 py-1 rounded-full">{group.date}</span>
                </div>
            ...
            {isLoading && (
              <div className="flex mb-4">
                <Avatar className="h-8 w-8 mr-2">
                  <div className="bg-primary-navy text-white h-full w-full flex items-center justify-center">B</div>
                </Avatar>
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <div className="flex items-center space-x-2">
          <Button variant="outline" size="icon" className="rounded-full" onClick={handleImageClick}>
